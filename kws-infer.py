...
def get_args():
    ...
    parser.add_argument("--checkpoint", type=str, default="https://github.com/mahikgot/197_kws_transformer/releases/download/checkpoint/transformer-kws-best-acc.ckpt")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if args.rpi:
            ...
            mel = ToTensor()(librosa.power_to_db(transform(waveform).squeeze().numpy(), ref=np.max))
        mel = rearrange(mel, 'c (p1 h) (p2 w) -> 1 (p1 p2) (c h w)', p1=4, p2=4)
        pred = model(mel)
