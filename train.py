...
class KWSDataModule(LightningDataModule):
    def __init__(self, path, batch_size=128, num_workers=0, patch_num=4, n_fft=512,
    ...
    def collate_fn(self, batch):
        ...
        for sample in batch:
            ...
            # self.plot_spectrogram(librosa.power_to_db(self.transform(waveform).squeeze().numpy()))
...
if __name__ == "__main__":
    ...
    model = LitTransformer(num_classes=args.num_classes, epochs=args.max_epochs, lr=args.lr, patch_dim=patch_dim, seqlen=seqlen)
